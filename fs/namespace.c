...
static int mnt_alloc_group_id(struct mount *mnt)
{
	...
	if (susfs_is_current_ksu_domain()) {
		return ida_get_new_above(&mnt_group_ida, DEFAULT_KSU_MNT_GROUP_ID, &mnt->mnt_group_id);
	}
#endif // #ifdef CONFIG_KSU_SUSFS_SUS_MOUNT
...
static noinline struct mount *clone_mnt(struct mount *old, struct dentry *root,
					int flag)
{
